...
<header class="main-header">
    <a class="logo" href="<?=Yii::$app->homeUrl?>"><span class="biglogo"><?php echo Html::img('/images/adminbiglogo.png');?></span><span class="smalllogo"><?php echo Html::img('/images/adminlogo.png');?></span></a>
