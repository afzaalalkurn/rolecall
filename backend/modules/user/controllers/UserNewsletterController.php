...
use Yii;
use backend\modules\user\models\UserNewsletter;
use backend\modules\user\models\search\UserNewsletter as UserNewsletterSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * UserNewsletterController implements the CRUD actions for UserNewsletter model.
 */
