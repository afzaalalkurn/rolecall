<?php
namespace backend\modules\job; 
use backend\modules\auth\components\Configs;

class Module extends \yii\base\Module
{
    public $controllerNamespace = 'backend\modules\job\controllers';

	/**
     * @inheritdoc
     */
    public $defaultRoute = 'job-settings';
     ...
     */
    public $mainLayout = 'backend/modules/job/views/layouts/main.php';
