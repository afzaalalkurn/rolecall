...
/**
 * This is the model class for table "core_ads_plan".
 *
 * @property integer $id
 ...
 */
class CoreAdsPlan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'paypal_plan_id' => Yii::t('app', 'Paypal Plan ID'),
            'name' => Yii::t('app', 'Name'),
