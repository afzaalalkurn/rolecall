...
use backend\modules\core\models\CorePlan as CorePlanModel;

/**
 * CorePlan represents the model behind the search form about `backend\modules\core\models\CorePlan`.
 */
class CorePlan extends CorePlanModel
{
    /**
     * @inheritdoc
     */
