...
'modules' => [
    ...
    'admin' => [
        ...
        'controllerMap' => [
            'assignment' => [
                'class' => 'backend\modules\auth\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `backend\modules\auth\components\AccessControl`:
