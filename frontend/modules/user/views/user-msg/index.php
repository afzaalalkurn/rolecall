...
<header class="entry-header">
   ...
   <a class="btn btn-primary" href="<?= Url::to("/user/user-msg/all-archive")?>">See All Archive</a>
</header>
...
<h2>Inbox</h2>
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                /*[
                    'label' => Yii::t('app','To'),
                    'attribute' => 'message.user.userProfile.name',
                ],*/
                [
                ...
                [
                    ...
                    'template' => '{view} {delete} {archive}',
                    'buttons' => [
                        'label' =>  'Archive',
                        'archive' => function ($url, $model, $key) {
                            return Html::a('<i class="fa fa-archive" aria-hidden="true"></i>', ['archive', 'message_id'=>$model->message_id, 'seq' => $model->seq]);
                        },
                    ]
                ],
            ],
