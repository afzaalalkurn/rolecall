...
class JobItemController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            $model->create_dated = Yii::$app->formatter->asDate($model->create_dated, 'php:Y-m-d H:i:s');
            $model->expire_date = Yii::$app->formatter->asDate($model->expire_date, 'php:Y-m-d H:i:s');
